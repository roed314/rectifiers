...
This is the idea behind our rectifier, generalizing Bushnell and Henniart's.
...
DeBacker-Reeder and Reeder.  In \S\ref{Q_T}, we study a class of characters $\alpha$ of a torus that
satisfy $\Lpack(\xi) = \Lpack(\xi \cdot \alpha)$ for all regular characters $\xi$.
