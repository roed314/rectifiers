...
rectifier to groups outside of $\GL_n(K)$.  In particular, we define a rectifier for
...
Since we will be using Adler's construction of supercuspidal representations
in \cite{adler},
