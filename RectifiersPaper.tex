...
a new notion of admissible pair.   We will show that a rectifier exists and, assuming a technical
condition about elliptic tori, is
...
We note that the elliptic torus in $SL_2(\mathbb{F}_3)$ presents an immediate obstruction to the 
conjecture's validity
for arbitrary $q$.  The question of placing additional conditions on the definition of rectifier 
...
a weak rectifier for $T$.  If $T$ satisfies
...
We have $\lambda \chi = {}^{w_{\chi}} (\chi)$.  ${}^{w_{\chi}} (\chi)$
also has order $m$.  Raising the equation $\lambda \chi = {}^{w_{\chi}} (\chi)$
...
Therefore, ${}^{w_{\xi}} (\mu_\xi)|_{T(\OL)_{\Gamma}} = \mu'_\xi|_{T(\OL)_{\Gamma}}$.
...
${}^{w_{\xi}} (\mu_\xi)|_{T(\OL)_{\Gamma}} = \mu'_\xi|_{T(\OL)_{\Gamma}} 1$
