...
The group $\Lx / \Nm_{L/K}(\Lx)$ is a cover of the elliptic torus $L^1$ of norm $1$ elements in $L$ as follows:
\begin{align*}
...
\proof
This follow from Corollary \ref{cor:rectifier_agreement} and Proposition \ref{prop:BH_result1}.
\qed
