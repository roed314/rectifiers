...
\newcommand{\Threg}{T^*_{\operatorname{reg}}}
\newcommand{\Thirr}{T^*_{\operatorname{irr}}}
\newcommand{\hatT}{T^*}
...
depth zero characters of $T(\OK)$, $\Threg$ for the admissible
characters and $\Thirr$ for the inadmissible ones.  Each of these
