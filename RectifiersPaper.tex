...
For investigating the uniqueness of rectifiers, it will be necessary to determine whether different
characters of a torus can yield the same L-packet.  Consider the following archetypical example.
Let $K = \QQ_3$, $G = \SL_2$ and $T$ an unramified anisotropic torus.  There are four depth zero
characters; the two regular ones are interchanged by the action of the Weyl group.
