...
from the Weil-Deligne group $\WD_K$ of $K$, to the $L$-group ${}^L G$ of $G$.
...
for tori would give us the desired character.  Instead, one has to rectify the
...
<<<<<<< HEAD
In this section, we show that our function ${}_K \boldsymbol\mu^{\mathrm{Reg}}$
...
>>>>>>> ba6f841e8ed7cff345976c95441a693e3ebfacec
