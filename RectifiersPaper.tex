...
This is the idea behind our rectifier, an extension of Bushnell and Henniart's.
...
\end{align*}
which attaches,
  to each admissible pair $(T, \xi) \in \Pmin(K)$, a character
...
the definition of admissible pair of \cite{bushnellhenniart} in
the case of unramified elliptic tori.
