...
if there is some $\alpha \in Q_T$ with $\mu_\xi' = \alpha \mu_\xi$ for all admissible $(T, \xi)$.\MAxxx{Comment here why
...
\end{enumerate}
We say that two weak rectifiers $\mumin$ and $(\mumin)'$ for $T$ are equivalent if there is an $\alpha \in Q_T$ with $(\mumin)' = \alpha\mumin$.
\end{definition}
...
Reducing mod $\PL$, we conclude \MAxxx{By condition (3) of rectifier?} that there exists a character,
...
We also note that nowhere in the proof of Theorem \ref{thm:unique_semisimple}
