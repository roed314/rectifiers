...
$T(L)_\Gamma$.  Note that not all minisotropic tori are coverable.  Consider the torus
$\Gm \times 
...
\end{align*}
since $g$ projects to $\Fr \in \Gamma$.  Define $\varphi_i \colon \Weil_L \rightarrow \hat{T}$ % SAY WHERE i RANGES
