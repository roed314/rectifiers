...
be the image of $f$ in $\hat{W}$, and let $w$ be the element of
$W$ corresponding to $\hat{w}$ (see \cite[p. 824]{debackerreeder}).  
...
\begin{definition}
Given $\varphi$, we define a homomorphism $\varphi_o : W_K \rightarrow {}^L G = <\hat{\theta}> \ltimes \hat{G}$ by
\begin{enumerate}
