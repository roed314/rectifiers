...
$\xi_{\varphi} : T(L) \rightarrow \CCx$.  Since $\varphi|_{W_L}$ extends
...
Since $\varphi|_{W_L}$ has image in $\hat{T} = X^*(T) \otimes \CCx$,
...
Suppose we define
$\varphi_{w}' : W_K \rightarrow \GL_{n}(\CC)$ by $\varphi_{w}'|_{I_K} \equiv 1$ and
