...
of $G(K)$ to the set of Langlands parameters.
...
rectify this situation in various ways.
...
by twisting $\chi$ by another character of
...
notion of a rectifier to groups other than $\GL_n(K)$.  In particular, we define rectifiers for
...
us to define rectifier and admissible pairs in the general setting.
...
Note that there is an obstruction to proving compatibility in the positive depth case:
in depth zero Deligne-Lusztig representations provide a canonical construction
of supercuspidal representations but in positive depth there are many:
Adler \cite{adler}, Howe, Bushnell-Henniart, Bushnell-Kutzko, Yu.
